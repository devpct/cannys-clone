...
router.post('/add/feedback', feedbackValidation,(req, res) => {FeedbackController.createFeedback(req, res)})
router.put('/update/feedback/:id', feedbackValidation,(req, res) => {FeedbackController.updateFeedback(req, res)})
